...
REST API that wraps all four TripMind models via Ollama. Accepts a traveler persona and returns an optimized itinerary from any of the three fine-tuned models or the untuned baseline.
...
Valid model names: `tripmind-ft`, `tripmind-distill`, `tripmind-curriculum`, `llama3.1:8b`.  
