...
| `tripmind-ft` | SFT on 4,749 Phase 1 synthetic pairs | 92 |
| `tripmind-distill` | Distilled from 449 Phase 2 agent traces | 92 |
| `tripmind-curriculum` | Two-stage: Phase 1 → Phase 2 sequential | 92 |
