...
M = {
    ...
    'ft': S['tripmind-ft'], 'distill': S['tripmind-distill'], 'curriculum': S['tripmind-curriculum'],
}
...
def radar():
    ...
    ax.set_title('TripMind — Per-Metric Comparison (4 models)', size=15, pad=28)
...
def struct_sem():
    ...
    fig.suptitle('TripMind — Structural vs Semantic Metrics', size=16, y=1.05)
...
def head_to_head():
    ...
    short = {'tripmind-ft': 'ft', 'tripmind-distill': 'distill', 'tripmind-curriculum': 'curriculum'}
    ...
    ax.set_title('TripMind — Head-to-Head Win Rates (LLM judge, 92 cases)', size=14, pad=12)
