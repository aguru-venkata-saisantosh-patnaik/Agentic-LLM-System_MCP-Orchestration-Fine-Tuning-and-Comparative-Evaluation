"""
Shared constants for the TripMind project.
...
# Fallback city-centre coordinates for all 20 TripMind cities.
...
SLM_FT_MODEL         = "tripmind-ft"         # Ollama model name (fine-tuned)
SLM_DIST_MODEL       = "tripmind-distill"    # Ollama model name (distilled)
SLM_CURRICULUM_MODEL = "tripmind-curriculum" # Ollama model name (curriculum-trained)
